...
it("returns query", async (ctx) => {
	...
	const { result } = renderHook(() => usePrismicDocuments(), {
...
it("supports params", async (ctx) => {
	...
	const { result } = renderHook(() => usePrismicDocuments(params), {
		wrapper: createWrapper(client),
	});
...
it("supports explicit client", async (ctx) => {
	...
	const { result } = renderHook(() => usePrismicDocuments({ client }), {
		wrapper: createWrapper(client),
	});
